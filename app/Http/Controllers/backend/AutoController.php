<?php
    ...
    class AutoController extends Controller
    {
        ...
        {
            $arr_automanufacturer = Automanufacturer::orderBy('title')->pluck('title', 'automanufacturer_id');
        ...
        public function anyData()
        {
            ...
            return Datatables::of($autos)
                    ...
                    {
                        return '<a href="auto/' . $auto->auto_id . '/edit" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>'
